  ...
  _i174.GetIt init({
    ...
    gh.factory<_i337.PersonDetailProvider>(
      () => _i337.PersonDetailProvider(
        getPersonPhotosUseCase: gh<_i211.GetPersonPhotosUseCase>(),
        toggleHomeDisplayUseCase: gh<_i763.ToggleHomeDisplayUseCase>(),
      ),
    );
    gh.factory<_i644.PersonProvider>(
      () => _i644.PersonProvider(
        getHomeDisplayPersonUseCase: gh<_i310.GetHomeDisplayPersonUseCase>(),
        getAllPersonUseCase: gh<_i406.GetAllPersonUseCase>(),
      ),
    );
    gh.factory<_i312.GalleryProvider>(
      () => _i312.GalleryProvider(
        getGalleryImagesUseCase: gh<_i607.GetGalleryImagesUseCase>(),
        updatePhotoPermissionUseCase: gh<_i829.UpdatePhotoPermissionUseCase>(),
      ),
    );
    gh.factory<_i725.GraphProvider>(
      () => _i725.GraphProvider(getGraphUseCase: gh<_i1022.GetGraphUseCase>()),
    );
    gh.factory<_i91.DragSearchProvider>(
      () => _i91.DragSearchProvider(
        getSearchUseCase: gh<_i356.GetSearchUseCase>(),
      ),
    );
